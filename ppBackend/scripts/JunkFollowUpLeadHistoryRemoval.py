...
def junk_follow_up_lead_history_removal(run=False):
    ...
    with app.test_request_context():
        ...
        data = {}
        count = 0
        data['transfer_to'] = '6242eec3e92df56342b07716'
        ...
        # print(leadh)
        # for lead in leadh:
        #     followup = FollowUpController.read_lead_follow(data = {'lead':'62778abada67522ede98d746', 'name':'', 'ref':''})
        ...
        #         followup_updatedata = {constants.FOLLOW_UP__ASSIGNED_TO: transfer_to,
        ...
        #     leads[constants.LEAD__ASSIGNED_TO] = transfer_to
